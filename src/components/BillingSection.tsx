...
export const BillingSection = () => {
  ...
  const handleBillingSearch = () => {
    if (!billingSearchQuery) return;

    const foundProduct = products.find(p => 
      p.code.toLowerCase() === billingSearchQuery.toLowerCase().trim()
    );
        ...
        <div className="mb-4">
          <div className="flex mb-2">
            <input
              ...
              onKeyPress={(e) => e.key === 'Enter' && handleBillingSearch()}
            />
            <button
              ...
              <div key={item.code} className="border rounded p-3">
                ...
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Code: {item.code} | Rs. {item.price}</div>
                  </div>
                  <button
